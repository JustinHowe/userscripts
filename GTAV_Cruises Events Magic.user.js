...
$(window).load(function(){
	...
	currentLocation = currentLocation[1].replace(/\_/, "+");
	...
	$("#eventsiFrame").load(function(){
		...
		$(".md").prepend('<blockquote><h3>Upcoming Cruises (' + events.length + ')</h3><p>' + eventsString + '<center><strong>Your timezone location: ' + currentLocation.replace(/\+/, " ") + '</strong></center></p></blockquote>');
	})
})